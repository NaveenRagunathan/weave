      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 text-center">
          {stats.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-ink-black/80 p-6 rounded-xl border border-imperial-gold-500/10">
        ...
        <div className="mb-16">
          ...
          <div className="bg-ink-black/60 p-8 rounded-xl border border-imperial-gold-500/10">
