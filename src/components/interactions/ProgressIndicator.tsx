  ...
  return (
    <div className={`fixed right-6 top-1/2 -translate-y-1/2 z-50 ${className}`}>
      ...
      <div className="w-1 h-64 bg-gray-800 rounded-full overflow-hidden mb-4">
        <div
          className="w-full bg-gradient-to-t from-silk-crimson-500 via-silk-crimson-400 to-imperial-gold-400 transition-all duration-300 ease-out"
        ...
        {sections.map((section, index) => (
          <div
            ...
            className={`w-3 h-3 rounded-full border-2 transition-all duration-300 ${
              index <= activeSection
                ? 'bg-silk-crimson-400 border-silk-crimson-400 shadow-lg shadow-silk-crimson-400/30'
