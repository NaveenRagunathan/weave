      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8"> {/* Adjusted grid for fewer categories */}
          {Object.entries(footerLinksConfig).map(([category, links]) => (
            <div key={category}>
              <h3 className="text-sm font-semibold text-silk-crimson-400 uppercase tracking-wide mb-4">
                {category}
              </h3>
           ...
           <div className="md:col-start-3 lg:col-start-auto">
             <h3 className="text-sm font-semibold text-silk-crimson-400 uppercase tracking-wide mb-4">Connect</h3>
                ...
                {socialLinksConfig.map((social) => {
                  ...
                  return (
                    <a
                      key={social.name}
                      href={social.href}
                      className="text-gray-400 hover:text-silk-crimson-400 transition-colors duration-200"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-8 h-8 bg-gradient-to-br from-silk-crimson-500 to-imperial-gold-500 rounded-lg flex items-center justify-center">
