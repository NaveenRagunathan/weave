...
const CloserSection = () => {
  return (
    <section className="py-24 lg:py-32 bg-gradient-to-b from-ink-black via-silk-crimson-900/10 to-ink-black text-pearl-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-8 text-xl text-pearl-white/90 leading-relaxed mb-12">
          ...
          <p className="mt-6 text-silk-crimson-400 font-semibold">
        ...
        <div className="space-y-6 sm:space-y-0 sm:flex sm:flex-col sm:items-center sm:space-x-0">
            <Button
                size="lg"
                className="w-full sm:w-auto bg-silk-crimson-600 hover:bg-silk-crimson-700 text-white px-10 py-5 text-xl font-semibold rounded-full shadow-2xl hover:shadow-silk-crimson-500/40 transition-all duration-300 group mb-4 sm:mb-0 border border-silk-crimson-400/30"
            >
            ...
            <Button
                variant="link"
                size="lg"
                className="text-silk-crimson-400 hover:text-silk-crimson-300 px-8 py-4 text-lg font-semibold group mt-4"
            >
