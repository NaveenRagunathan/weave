    ...
    <section className="py-24 lg:py-32 bg-silk-crimson-400 text-pearl-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-6 sm:space-y-0 sm:flex sm:flex-col sm:items-center sm:space-x-0">
            <Button
                size="lg"
                className="w-full sm:w-auto bg-silk-crimson-600 hover:bg-silk-crimson-700 text-white px-10 py-5 text-xl font-semibold rounded-full shadow-2xl hover:shadow-silk-crimson-500/40 transition-all duration-300 group mb-4 sm:mb-0"
            >
