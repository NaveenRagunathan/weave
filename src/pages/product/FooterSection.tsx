...
const FooterSection = () => (
    <footer className={`${gradients[2]} border-t-2 border-imperial-gold-500/25 pt-12 pb-3 px-4 font-sans shadow-[0_-2px_12px_0_rgba(212,175,55,0.04)]`}>
    <div className="max-w-6xl mx-auto">
          ...
          {socials.map((s) => {
            ...
            return (
              <a
                ...
                href={s.href}
                aria-label={s.name}
                                className="rounded-full p-2 bg-white/50 hover:bg-imperial-gold-500/15 text-silk-crimson-400 hover:text-imperial-gold-500 transition flex items-center justify-center border border-imperial-gold-500/20 hover:border-silk-crimson-400/40 shadow-sm"
              >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2">
                  <div className="text-ink-black/80 text-sm">
          © 2025 WEAVE Financial Systems
        </div>
                <div className="text-ink-black/60 italic text-xs sm:text-base text-right">
