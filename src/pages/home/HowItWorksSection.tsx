  ...
  return (
      ...
      <div className="mx-auto max-w-4xl px-4 lg:px-0">
        <div className="text-center">
          <h2 className="text-base font-bold tracking-widest text-brand-blue uppercase mb-2">HOW WEAVE WORKS</h2>
          <div className="grid gap-10 md:grid-cols-3 mt-12">
            {steps.map((step, idx) => (
              <div
                key={step.title}
                className="flex flex-col items-center bg-white border border-brand-blue/30 rounded-2xl px-6 py-10 shadow-glow-blue"
              >
          ...
          <div className="text-center mt-14">
            <a
              href="#"
              className="inline-flex items-center justify-center px-8 py-3 border border-brand-blue text-base font-bold rounded-full text-brand-blue bg-white hover:bg-brand-blue/10 hover:text-brand-blue transition-all duration-200 shadow-md"
            >
